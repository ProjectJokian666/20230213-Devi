				...
				<div class="card-body">
					...
					<div class="col-12 row">
						...
						<div class="col-3" id="show_filter_button">
							...
							<a href="{{url('admin/data')}}" class="btn btn-primary text-white"><i class="ri-loader-3-fill"></i></a>
						</div>
					</div>
					<!-- Default Table -->
...
<script type="text/javascript">
	...
	function show_wilayah() {
		...
		$.ajax({
			url:'{{route('admin.data.wilayah_by_bencana')}}',
			type:"GET",
			data:{
	...
	function show_tahun() {
		$.ajax({
			url:'{{route('admin.data.tahun_by_wilayah_by_bencana')}}',
			type:"GET",
			data:{
				id_bencana:$('#filter_bencana').val(),
	...
	function show_data() {
		...
		if (bencana!=null&&wilayah==null&&tahun==null) {
			...
			$.ajax({
				url:"{{route('admin.data.show_wilayah_by_bencana')}}",
				type:"GET",
				data:{
					id_bencana:bencana,
				},
		...
		if (bencana!=null&&wilayah!=null&&tahun==null) {
			...
			$.ajax({
				url:"{{route('admin.data.show_tahun_by_wilayah_by_bencana')}}",
				type:"GET",
				data:{
					id_bencana:bencana,
					id_wilayah:wilayah,
		...
		if (bencana!=null&&wilayah!=null&&tahun!=null) {
			...
			$.ajax({
				url:"{{route('admin.data.show_data_tahun_by_wilayah_by_bencana')}}",
				type:"GET",
				data:{
					id_bencana:bencana,
					id_wilayah:wilayah,
