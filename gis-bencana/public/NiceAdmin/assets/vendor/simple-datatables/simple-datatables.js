                ...
                (function() {
                    ...
                    function d(t, e, s) {
                        ...
                        case s._const.addTextElement:
                            var u;
                            if (h = (u = d.slice()).splice(u.length - 1, 1)[0],
                            ...
                            var t = function(t, e, s, i) {
                                ...
                                for (var u = 0; u < o; u++)
                                    for (var f = t[u], m = 0; m < r; m++) {
                                        var g = e[m];
                                        s[u] || i[m] || !b(f, g, d, c) ? l[u + 1][m + 1] = 0 : (l[u + 1][m + 1] = l[u][m] ? l[u][m] + 1 : 1,
                                        l[u + 1][m + 1] >= n && (n = l[u + 1][m + 1],
                                        a = [u + 1, m + 1]))
                                    }
                                return 0 !== n && {
                                    oldValue: a[0] - n,
                    ...
                    var $ = {
                      ...
                      , S = function() {
                        function t(t, e, s) {
                            ...
                            this.diffcount = 0,
                            this.foundAll = !1,
                            this.debug && (this.t1Orig = "undefined" != typeof Element && t instanceof Element ? D(t, this.options) : "string" == typeof t ? L(t, this.options) : JSON.parse(JSON.stringify(t)),
                        ...
                        t.prototype.findDiffs = function(t, e) {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (g(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
                                f(t),
                        ...
                        t.prototype.findOuterDiff = function(t, e, s) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                                return "#text" === t.nodeName ? [(new y).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)] : [(new y).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
                            for (n = t.attributes ? Object.keys(t.attributes).sort() : [],
                            a = e.attributes ? Object.keys(e.attributes).sort() : [],
                            o = n.length,
                            l = 0; l < o; l++)
                                i = n[l],
                                -1 === (r = a.indexOf(i)) ? d.push((new y).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1),
                                t.attributes[i] !== e.attributes[i] && d.push((new y).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                            for (o = a.length,
                            l = 0; l < o; l++)
                                i = a[l],
                                d.push((new y).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                            return d
                        }
                        ,
                                ...
                                u && p)
                                    if (!this.options.maxChildCount || a < this.options.maxChildCount)
                                        ...
                                        if (i.length > n.length)
                                            ...
                                            var f = m(p);
                                            r = r.concat([(new y).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, f).setValue(this.options._const.route, s.concat(l))]),
                                            i.splice(h, 0, f),
                                            o -= 1
                                        } else
                                            r = r.concat([(new y).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, m(u)).setValue(this.options._const.newValue, m(p)).setValue(this.options._const.route, s.concat(l))]);
                                l += 1
                            }
                        ...
                        t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
                            ...
                            }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), g = [], _ = 0, w = 0; _ < f; w += 1,
                            _ += 1)
                                if (!n || !0 !== u[_] && !0 !== p[_])
                                    if (!0 === u[_])
                                            ...
                                            if ("#text" === e.childNodes[_].nodeName) {
                                                if (l.data !== e.childNodes[_].data) {
                                                    for (c = w; t.childNodes.length > c + 1 && "#text" === t.childNodes[c + 1].nodeName; )
                                                        if (c += 1,
                                                        e.childNodes[_].data === t.childNodes[c].data) {
                                                            d = !0;
                                                            break
                                                        }
                                                    if (!d)
                                                        return g.push((new y).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, e.childNodes[_].data)),
                                                        g
                                                }
                                            } else
                                                g.push((new y).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)),
                                                u.splice(_, 1),
                                                f = Math.min(u.length, p.length),
                                                _ -= 1;
                                        else
                                            g.push((new y).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, m(l))),
                                            u.splice(_, 1),
                                            f = Math.min(u.length, p.length),
                                            _ -= 1;
                                    else if (!0 === p[_])
                                        "#text" === (l = e.childNodes[_]).nodeName ? (g.push((new y).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)),
                                        u.splice(_, 0, !0),
                                        f = Math.min(u.length, p.length),
                                        w -= 1) : (g.push((new y).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, m(l))),
                                        u.splice(_, 0, !0),
                                        f = Math.min(u.length, p.length),
                                        w -= 1);
                                    else if (u[_] !== p[_]) {
                                        ...
                                        (o = Math.min(r.newValue, t.childNodes.length - r.length)) !== r.oldValue) {
                                            ...
                                            for (var x = 0; x < r.length; x += 1)
                                                b(t.childNodes[o + x], t.childNodes[r.oldValue + x], {}, !1, !0) || (a = !0);
                                            if (a)
                                                return [(new y).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                                        }
                                    }
                            return g
                        }
                        ...
                        t.prototype.findValueDiff = function(t, e, s) {
                            var i = [];
                            return t.selected !== e.selected && i.push((new y).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                            (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new y).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)),
                    ...
                    const A = (t,e,s,{classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l},{noColumnWidths: d, unhideHeader: c})=>({
                      ...
                      , P = (t,e,s,i,n,a,{classes: o, hiddenHeader: r, header: l, footer: d, format: c, sortable: h, scrollY: u, type: p, rowRender: f, tabIndex: m},{noColumnWidths: g, unhideHeader: b, renderHeader: v})=>{
                        ...
                        if (_.attributes.class = _.attributes.class ? `${_.attributes.class} ${o.table}` : o.table,
                        l || d || v) {
                            const t = A(e, i, n, {
                                classes: o,
                                hiddenHeader: r,
                        ...
                        return !1 !== m && (_.attributes.tabindex = String(m)),
                        _
                    }
                    ;
                    ...
                    R.exports = function() {
                        ...
                        var M = function() {
                            ...
                            b.diff = function(i, u, p) {
                                var f, m = D.p(u), g = N(i), b = (g.utcOffset() - this.utcOffset()) * e, v = this - g, _ = D.m(this, g);
                                return _ = (f = {},
                                f[h] = _ / 12,
                                f[d] = _,
                                f[c] = _ / 3,
                    ...
                    const Q = {
                      ...
                      , X = (t,e,s,i,n)=>{
                        let a = [];
                        if (n.firstLast && a.push(Z(1, n.firstText, n)),
                        n.nextPrev) {
                            const e = t ? 1 : s - 1;
                    ...
                    exports.DataTable = class {
                        ...
                        multiSearch(t) {
                            ...
                            const e = t.map((t=>this.columns.settings.map(((e,s)=>{
                                ...
                                return (e.ignorePunctuation || this.options.ignorePunctuation) && (i = i.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, "")),
                                i
                            }
                            ))));
                            ...
                            if (Array.isArray(e)) {
                                ...
                                e.forEach(((e,i)=>{
                                    ...
                                    Object.entries(e).forEach((([e,s])=>{
                                        const a = t.indexOf(e);
                                        a > -1 ? n[a] = F(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[t.length] = F(s, this.columns.settings[t.length]),
                                        t.push(e),
                                ...
                                t(e) && (!e.headings || this.hasHeadings || this.hasRows ? e.data && Array.isArray(e.data) && (s = e.data.map((t=>t.map(((t,e)=>F(t, this.columns.settings[e])))))) : this.data = U(e, void 0, this.columns.settings, this.options.type, this.options.format));
